...
Invoke-VastText -Config $config -Arguments @('start', 'instance', [string]$state.instance_id, '--raw') | Out-Host
...
Write-Host "Instance $($state.instance_id) is running." -ForegroundColor Green
